    ...
    <section className="border-b border-white/10 bg-[#111416]">
      <div className="mx-auto max-w-360 px-5 py-20 sm:px-8 lg:px-12">
        <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr]">
          <div>
            <p className="text-xs font-bold uppercase tracking-wider text-emerald-400">UploadFlow in plain English</p>
            ...
            <p className="mt-5 border-l-2 border-[#eefb7a] pl-4 text-base font-bold leading-relaxed text-white/85">
        ...
        <div className="mt-14 rounded-3xl border border-white/15 bg-[#0b0d0f] p-6 sm:p-8">
          <p className="text-xs font-bold uppercase tracking-wider text-[#eefb7a]">Everyday example</p>
          <p className="mt-4 max-w-4xl text-base sm:text-lg leading-relaxed text-white/70">
    ...
    <section className="border-b border-white/10">
      <div className="mx-auto max-w-360 px-5 py-20 sm:px-8 sm:py-28 lg:px-12">
        <div className="max-w-3xl">
          <p className="text-xs font-bold uppercase tracking-wider text-[#eefb7a]">What problem does it solve?</p>
        ...
        <div className="mt-12 overflow-hidden rounded-3xl border border-white/15">
          {productProblems.map(([problem, solution]) => (
            <article key={problem} className="grid border-b border-white/10 last:border-b-0 sm:grid-cols-[.7fr_1.3fr]">
              ...
              <p className="p-5 text-sm sm:text-base leading-relaxed text-white/55 sm:p-6">{solution}</p>
            </article>
          ))}
        </div>

        <div className="mt-24">
          <p className="text-xs font-bold uppercase tracking-wider text-emerald-400">Practical use cases</p>
          ...
          <div className="mt-10 grid border-l border-t border-white/15 md:grid-cols-2 lg:grid-cols-3">
            {practicalUseCases.map((useCase) => (
              <article key={useCase.audience} className="border-b border-r border-white/15 p-6 sm:p-8">
                ...
                <p className="mt-5 border-t border-white/10 pt-4 text-xs sm:text-sm font-bold uppercase leading-5 tracking-wide text-[#eefb7a]">
                  {useCase.benefit}
                </p>
              </article>
            ))}
...
export function CommonQuestionsSection() {
  return (
    <section className="border-b border-white/10 bg-[#111416]">
      <div className="mx-auto max-w-360 px-5 py-20 sm:px-8 lg:px-12">
        <p className="text-xs font-bold uppercase tracking-wider text-emerald-400">Direct answers</p>
        ...
        <div className="mt-10 grid border-l border-t border-white/15 lg:grid-cols-2">
          {commonQuestions.map((item) => (
            <article key={item.question} className="border-b border-r border-white/15 p-6 sm:p-8">
              ...
              <p className="mt-4 text-sm sm:text-base leading-relaxed text-white/55">{item.answer}</p>
            </article>
          ))}
        </div>
      </div>
